...
class Config:
    ...
    query_folder = './Data/campus_data_with_indicies/query_drone/2'
    ...
    csv_file = './Data/campus_data_with_indicies/drone_airstrip.csv'  # Path to CSV file containing coordinates

...
def get_transforms(img_size,
    ...
    train_sat_transforms = A.Compose([A.ImageCompression(quality=95, p=0.5),
                                      ...
                                      A.OneOf([
                                               ...
                                               A.CoarseDropout(max_holes=25, max_height=20, max_width=20, p=0.5),
                                              ], p=0.3),
    ...
    train_drone_transforms = A.Compose([A.ImageCompression(quality=95, p=0.5),
                                        A.Resize(img_size[0], img_size[1], interpolation=cv2.INTER_LINEAR_EXACT, p=1.0),
                                        A.ColorJitter(brightness=0.15, contrast=0.15, saturation=0.15, hue=0.15, p=0.5),
                                        A.OneOf([
                                                 A.AdvancedBlur(p=1.0),
